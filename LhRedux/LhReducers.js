...
const LhCartReducer = (st = cart, action) => {
...
const LhUserReducer = (st = userState, action) => {
  switch (action.type) {
...
const LhCrntPrdtReducer = (state = crntPrdtState, action) => {
  switch (action.type) {
...
const LhToggleFav = (state = FavItems, action) => {
  switch (action.type) {
